...
const routes = [
  ...
  },
  {
    ...
    children:[
      ...
      {
        path:'research',
        component: () => import('../components/User/Research')
      },
      {
        path:'following',
        component: () => import('../components/User/Following')
      },
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: 'project',
        component: () => import('../views/Achievement/components/AddProject.vue'),
      },
