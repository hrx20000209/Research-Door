        ...
        <el-card class="box-card">
          ...
          >
            ...
            <el-form-item prop="number">
              ...
              <el-input v-model="formData.number" placeholder="Please input the number" style="width:350px"></el-input>
            </el-form-item>
            <el-form-item prop="institution">
              <template #label>
                <div style="font-size:20px; font-weight:600">Institution</div>
              </template>
              <el-input v-model="formData.institution" placeholder="Please input the institution" style="width:350px"></el-input>
            </el-form-item>
            <el-form-item>
              ...
              <el-dialog title="Notice" :visible.sync="showBox" :show-close="false" :close-on-click-modal="false" width="25%">
                <div style="font-size:15px">Are you sure to sumbit this report?</div>
                <template #footer>
