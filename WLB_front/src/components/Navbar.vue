<template>
  <div class="wrapper">
    <div class="logo" style="margin-left: 6vw; font-family: Rockwell; font-weight: 800; font-size: 1.2vw" @click="$router.push('/')">
      ResearchDoor
    </div>
    <div class="router">
      <span class="router_items" @click="$router.push('/square')">square</span>
      <span class="router_items" @click="$router.push('/question')">questions</span>
    </div>
    <div class="search">
      <el-input style="width: 40vw" placeholder="search for publication, author or questions" v-model="searchinput"
